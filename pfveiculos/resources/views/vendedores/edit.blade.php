...
@section('content')
    <div class="container-fluid">
        <h1>Editando Vendedor: {{$vendedor->nome}}</h1>
        ...
        <div class="form-group">
            ...
            {!! Form::text('sobrenome', $vendedor->sobrenome, ['class'=>'form-control']) !!}
        </div>

        <div class="form-group">
            {!! Form::label('cpf', 'CPF:') !!}
            {!! Form::text('cpf', $vendedor->cpf, ['class'=>'form-control', 'placeholder'=>'04098930066', 'maxlength'=>'14']) !!}
        </div>

        <div class="form-group">
            {!! Form::label('aniver', 'Data Nascimento:') !!}
            {!! Form::date('aniver', $vendedor->aniver, ['class'=>'form-control']) !!}
        </div>

        <div class="form-group">
            {!! Form::label('telefone', 'Telefone:') !!}
            {!! Form::text('telefone', $vendedor->telefone, ['class'=>'form-control', 'placeholder'=>'(00) 00000-0000', 'maxlength'=>'15','onkeydown'=>'masktel(this.value)']) !!}
        </div>

        <div class="form-group">
            {!! Form::submit('Editar Verndedor', ['class'=>'btn btn-primary']) !!}
        </div>
