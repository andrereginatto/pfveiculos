...
@section('content')
    <div class="container-fluid">
        ...
        <div class="form-group">
            {!! Form::label('cpf', 'CPF:') !!}
            {!! Form::text('cpf', $cliente->cpf, ['class'=>'form-control', 'placeholder'=>'04098930066', 'maxlength'=>'14']) !!}
        </div>

        <div class="form-group">
            {!! Form::label('aniver', 'Data Nascimento:') !!}
            {!! Form::date('aniver', $cliente->aniver, ['class'=>'form-control']) !!}
        </div>

        <div class="form-group">
            {!! Form::label('telefone', 'Telefone:') !!}
            {!! Form::text('telefone', $cliente->telefone, ['class'=>'form-control', 'placeholder'=>'(00) 00000-0000', 'maxlength'=>'15','onkeydown'=>'masktel(this.value)']) !!}
        </div>
